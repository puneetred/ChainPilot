...
research_agent = Agent(
    name="Research Agent",
    instructions="You are a cyrpto and blockchain research agent, your task is to do market research about the query and revert to asked with the suggestions. You have access to Duckduckgo search engine. You can query it what ever news, information you want. Do not cross question anything. Just revert the answer or suggestion.",
    functions=[
        search_duckduckgo,
        revert_to_asker,
        current_datetime,
...
# Create the ChainPilot with all available functions
chainpilot = Agent(
    name="ChainPilot",
    instructions=
